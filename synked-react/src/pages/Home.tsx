...
export function HomePage() {
  return (
    <>
      <Helmet>
        <title>Synked.ai — AI Agent Automation Studio</title>
        <meta
          name="description"
          content="We design, deploy, and continuously manage intelligent AI agents that automate workflows, handle customer interactions, and integrate seamlessly into your existing systems."
        />
      </Helmet>
      <Hero />
      <TickerBand />
